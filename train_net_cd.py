...
class Trainer(DefaultTrainer):
    """
    Extension of the Trainer class adapted to MARIS.
    """
...
def setup(args):
    ...
    # Setup logger for "maris" module
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="maris")
    return cfg
...
if __name__ == "__main__":
    ...
    launch(
        ...
        dist_url=f'tcp://localhost:{free_port}',
        args=(args,),
    )
